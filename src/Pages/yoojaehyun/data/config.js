...
const SERVER = 'http://54.180.202.185:8000';
const SIGNUP_API = `${SERVER}/account/`;
const SIGNIN_API = `${SERVER}/account/login`;
export { navbarSvg, feedSvg, SIGNUP_API, SIGNIN_API, SERVER };
